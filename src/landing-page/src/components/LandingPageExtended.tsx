...
import { CheckCircle, ArrowRight, Github, Twitter, BookOpen, Shield } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="libr-button-primary">
                View Documentation
              </button>
              <button className="libr-button-secondary">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex gap-4">
              <Twitter className="w-5 h-5 hover:text-libr-accent1 cursor-pointer transition-colors text-foreground" />
              <Github className="w-5 h-5 hover:text-libr-accent1 cursor-pointer transition-colors text-foreground" />
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li><a href="#" className="hover:text-libr-accent1 transition-colors">GitHub</a></li>
              <li><a href="#" className="hover:text-libr-accent1 transition-colors">Research Paper</a></li>
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4 text-sm">
              Get updates on LIBR protocol development.
            </p>
            <div className="flex gap-2">
              <input 
                type="email" 
                placeholder="Enter your email"
                className="flex-1 px-3 py-2 rounded-lg bg-muted border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-libr-accent1"
              />
              <button className="px-4 py-2 bg-libr-accent1 text-white rounded-lg hover:bg-libr-accent1/90 transition-colors">

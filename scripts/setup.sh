...
echo "2. 🐛 Find a 'good first issue': https://github.com/devlup-labs/libr/labels/good%20first%20issue"
...
echo ""
echo "❓ Need help?"
echo "   • Create an issue: https://github.com/devlup-labs/libr/issues/new"

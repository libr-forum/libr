...
\cfoot{\thepage}
\renewcommand{\headrulewidth}    \item \textbf{Scalability:} Load testing results and optimization plans
\end{itemize}

\subsubsection{Market Validation}pt}

% Title formatting
\titleformat{\section}{\Large\bfseries\color{blue!70!black}}{\thesection}{1em}{}
\titleformat{\subsection}{\large\bfs\end{tabular}
\end{center}

\end{document}s\color{blue!50!black}}{\thesubsection}{1em}{}

...
Page custom FinishPageCreate LeaveFinishPage
...
Function FinishPageCreate
    ...
    ${NSD_CreateLabel} 0u 0u 100% 20u "Installation was successful."
    Pop $0

    ${NSD_CreateCheckbox} 0u 30u 100% 12u "Run Libr now"
    Pop $Check_RunLibr
    ${NSD_Check} $Check_RunLibr

    ${NSD_CreateCheckbox} 0u 50u 100% 12u "Start Libr on system startup"
    Pop $Check_RunOnStartup

    nsDialogs::Show
FunctionEnd

Function LeaveFinishPage
    ${NSD_GetState} $Check_RunLibr $0
    ${If} $0 == ${BST_CHECKED}
